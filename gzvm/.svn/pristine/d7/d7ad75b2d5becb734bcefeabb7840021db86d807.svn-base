...
<link rel="stylesheet" href="/gzvm/manage/css/game_package.css">
...
<body>
		...
		<div class="row mg_choice_panel">
			...
			<div class="col-md-10 mg_right_panel">
				<div class="row ctrl_panel">
					<div class="col-md-6">
						<div class="col-md-3 ctrl_item"  onclick="openAdd();">
	...
	<script type="text/javascript" src="/gzvm/manage/js/game_package.js"></script>
