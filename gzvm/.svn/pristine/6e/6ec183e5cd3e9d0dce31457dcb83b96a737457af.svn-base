...
<link rel="stylesheet" href="/gzvm/manage/css/game_sign_item.css">
...
<body>
			...
			<div class="col-md-2 mg_left_panel">
				...
				<div class="mg_choice_item">
					...
					<ul class="mg_choice_list">
						...
						<li class="mg_list_item mg_active">报名管理</li>
			...
			<div class="col-md-10 mg_right_panel">
				<div class="row ctrl_panel">
					<div class="col-md-7" style="padding-left:0;">
						<div class="col-md-2 ctrl_item ctrl_item_add" onclick="window.location.href='/gzvm/manage/pages/game/game_sign_up.jsp';">
	...
	<script type="text/javascript" src="/gzvm/manage/js/game_sign_item.js"></script>
