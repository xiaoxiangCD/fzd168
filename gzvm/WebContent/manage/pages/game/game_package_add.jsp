...
<link rel="stylesheet" href="/gzvm/manage/css/game_package_add.css">
...
<body>
		...
		<div class="row mg_choice_panel">
			<div class="col-md-2 mg_left_panel">
				...
				<div class="mg_choice_item">
					...
					<ul class="mg_choice_list">
						...
						<li class="mg_list_item  mg_active">参赛包管理</li>
			...
			<div class="col-md-10 mg_right_panel">
				<div class="row ctrl_panel">
					<div class="col-md-6">
						<div class="col-md-6 ctrl_item"  onclick="openAdd();">
							<a>参赛包管理</a>><a>新增参赛包</a>
						</div>
	...
	<script type="text/javascript" src="/gzvm/manage/js/game_package_add.js"></script>
