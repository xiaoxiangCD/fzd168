...
<link rel="stylesheet" href="/gzvm/manage/css/role.css">
<link type="text/css" rel="stylesheet" href="/gzvm/css/sweetalert.css">
<link rel="stylesheet" type="text/css" href="/gzvm/css/easyui.css">
<script type="text/javascript" src="/gzvm/js/jquery-1.11.3.js"></script>
<script type="text/javascript" src="/gzvm/js/jquery.easyui.min.js"></script>
...
<body>
		...
		<div class="row mg_choice_panel">
			<div class="col-md-2 mg_left_panel">
				<div class="mg_choice_item">
					...
					<ul class="mg_choice_list">
						...
						<li class="mg_list_item  mg_active">角色管理</li>
					</ul>
				</div>
				<div class="mg_choice_item">
			...
			<div class="col-md-10 mg_right_panel">
				...
				<div class="row table_panel">
					<table id="table" data-undefined-text="暂无数据"></table>
				</div>
			</div>
		</div>
	</div>
	  ...
	  <form action="" id="addForm">
		...
		<div class="mg_add_middle">
			<div class="row form-group mg_add_item">
				<div class="col-md-2 mg_add_item_label"><label>名称:</label></div>
				<div class="col-md-10">
				<input type="text" class="form-control" placeholder="请输入角色名称" id="roleName">
				</div>
			</div>
			<div class="row form-group mg_add_item">
				<div class="col-md-2 mg_add_item_label"><label>编码:</label></div>
				<div class="col-md-10">
				<input type="text" class="form-control" placeholder="请输入角色编码" id="roleCode">
				</div>
			</div>
			<div class="row form-group mg_add_item">
				<div class="col-md-2 mg_add_item_label"><label>描述:</label></div>
				<div class="col-md-10">
				<input type="text" class="form-control" placeholder="请输入角色描述" id="roleDescribe">
				</div>
			</div>
			<div class="row form-group mg_add_item">
		...
		<div class="mg_add_bottom">
			<div class="mg_addbtn_panel"><button class="btn mg_addsure_btn mg_btn" onclick="saveRole();" >确定</button></div>
			<div class="mg_addbtn_panel"><button class="btn mg_addcancel_btn" onclick="closeAdd();" >取消</button></div>
		</div>
	  </form>
	</div>
	
	<div id="choiceWindow" class="mg_add_window">
	  <form action="" id="choiceForm">
		<div class="mg_add_top">
			<p class="mg_addtitle_font">定义模块</p>
			<p class="mg_addtitle_icon"><img alt="" src="/gzvm/manage/images/close.png" class="mg_addicon_img" onclick="closeChoice();"></p>
		</div>
		<div class="mg_add_middle">
			<div class="row form-group mg_add_item">
				<div class="col-md-3 mg_add_item_label"><label>选择模块:</label></div>
				<div class="col-md-9">
					<select id="combobox"  class="select1 easyui-combobox text_box form-control " style="height:35px; padding:10px;">
					<!-- 	<option value="1">商圈专营</option>
						<option value="2">商圈开放</option>
						<option value="3">社区店</option>
						<option value="4">农村店</option>
		...
		<div class="mg_add_bottom">
			<div class="mg_addbtn_panel"><button class="btn mg_addsure_btn mg_btn" onclick="saveModule();" >确定</button></div>
			<div class="mg_addbtn_panel"><button class="btn mg_addcancel_btn" onclick="closeChoice();" >取消</button></div>
		</div>
	  </form>
	</div>
	...
	<script type="text/javascript" src="/gzvm/manage/js/role.js"></script>
