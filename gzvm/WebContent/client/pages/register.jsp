...
<div class="bg">
	...
	<div class="container content space_top">
		...
		<div class="infor w space_top space_bottom" id="basic">
			<p class="hint align_c w space_top">为了保证您能正常浏览，请保证您所有填写信息正确无误！</p>
			...
			<div class="row space_bottom">
				<div class="col-md-1"></div>
				<div class="col-md-1 align_l"><span class="required">*</span>收货地址</div>
				<div class="col-md-7">
		...
		<div class="infor w space_top space_bottom" id="success">
			<div class="row space_bottom hint_panel">
				...
				<div class="col-md-5">
					<p class="success_hint align_l w space_top">恭喜您注册成功！</p>
				</div>
