...
<div class="bg">
	...
	<div class="container content space_top">
		<div class="sub_nav float_l">
			...
			<!-- <a href="/gzvm/client/pages/changePassword.jsp"> -->
				<p>修改密码</p>
			</div>
			<div class="sub_type mine">
			<!-- <a href="/gzvm/client/pages/competitionDetail.jsp"> -->
				<p>我的购物车</p>
			</div>
			<div class="sub_type grade">
			<!-- <a href="/gzvm/client/pages/competitionList.jsp"> -->
				<p>订单查询</p>
			</div>
		</div>
		...
		<div class="detail float-l">
			<div class="infor w  space_bottom ">
				<div class="detail_title align_l w space_bottom">
					...
					<p class="detail_dsc">（PS:为了保证您能正常浏览，请保证您所有填写信息正确无误！）</p>
				</div>
