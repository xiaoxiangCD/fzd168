...
<link type="text/css" rel="stylesheet"
	href="/gzvm/fzd/css/ancient_health.css">
...
<body>
		...
		<div class="row mg_choice_panel">
			<div class="col-md-2 mg_left_panel">
				<div class="mg_choice_item">
					<ul class="mg_choice_list" id="items">
						<li class="mg_list_item mg_active" id="L1">养生概况</li>
						<li class="mg_list_item" id="L2">文化交流</li>
					</ul>
				</div>
			</div>
			...
			<div class="col-md-10" id="rightPanel">
				<!-- <div class="col-md-12" id="healthTalk">
					...
					<div class="row health_panel">
						<div class="col-md-12 col-sm-12 col-xs-12 health_mobile_list">
							<div class="health_product_panel">
								<a class="health_product_item" href="/gzvm/fzd/pages/health_item.jsp">中国专业养生行业是未来中国健康产业发展的必然趋势。</a>
							</div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12 health_mobile_list">
							<div class="health_product_panel">
				...
				<div class="col-md-12" id="cultural_exchange">
					<div class="row ctrl_panel">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="col-md-3 ctrl_item">
								<p id="itemName"></p>
					...
					<div class="row anli_panel" id="contents">
						<!-- <div class="col-md-6 col-sm-6 col-xs-12 anli_mobile_list">
							<div class="anli_product_panel">
								<a class="anli_product_name"><img src="/gzvm/fzd/images/show01.jpg" class="anli_product_img"></a>
		...
		<div class="cd-navigation-wrapper">
			<div class="cd-half-block">
				...
				<ul class="cd-primary-nav" id="sNav">
					<li><a href="/gzvm/fzd/pages/fzd_index.jsp" class="selected">- 首页 </a></li>
				</ul>
				</nav>
			</div>
		</div>
	...
	<script src="/gzvm/fzd/js/ancient_health.js"></script>
</body>
</html>