...
<link type="text/css" rel="stylesheet"
	href="/gzvm/fzd/css/product_show.css">
				...
				<div class="row">
					...
					<div class="col-md-7 col-sm-10 hidden-xs nav_panel">
						<ul class="nav h" id="nav">
							...
							<li class="h"><a href="/gzvm/fzd/pages/ancient_health.jsp"> 古方养生 </a></li>
							<li class="h active"><a href="/gzvm/fzd/pages/product_show.jsp"> 产品展示 </a></li>
							<li class="h"><a href="/gzvm/fzd/pages/case_show.jsp">案例展示 </a></li>
							<li class="h"><a href="/gzvm/fzd/pages/shop_fzd.jsp"> 商城 </a></li>
							<li class="h"><a href="/gzvm/fzd/pages/about_fzd.jsp"> 关于锋之道 </a></li>
						</ul>
					</div>
