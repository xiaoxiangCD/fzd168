...
public class Base64Util
{
	...
	public static void main( String[] args ) throws Exception
    {
       ...
       String s= encodeString( "aaaaaa","gbk") ;
       System.out.println(s);
       s=Base64Util.decodeToString(s, "gbk");
       System.out.println(s);
     }   // end main
...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static String encodeObject(java.io.Serializable serializableObject, boolean breakLines)
    {
        ...
        try
        {
            ...
            b64os = new Base64Util.OutputStream(baos, Base64Util.ENCODE, breakLines);
     ...
     * @since 1.4
     */
    private static String encodeBytes( byte[] source, boolean breakLines)throws Exception
    {   
     ...
     * @since 1.4
     */
    public static String encodeBytes( byte[] source, int off, int len, boolean breakLines)throws Exception
    {
        int    len43   = len * 4 / 3;
     ...
     * @since 1.3
     */
    public static String encodeString( String s ,String charset)throws Exception
    {
     ...
     * @since 1.3
     */
    private static String encodeString( String s, boolean breakLines ,String charset)
    throws Exception
    {   
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
     ...
     * @since 1.4
     */
    public static String decodeToString( String s ,String charset)throws Exception
    {  
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
		...
		public void write(int theByte) throws java.io.IOException 
        {
            if( encode )
            {
                ...
                {   
                    out.write( Base64Util.encode3to4( buffer, bufferLength ) );
            ...
            else 
            {
                ...
                if( DECODABET[ theByte & 0x7f ] > WHITE_SPACE_ENC )
                {
                    ...
                    {   
                        out.write( Base64Util.decode4to3( buffer ) );
                        position = 0;
                    }   // end if: enough to output
		...
		public void flush() throws java.io.IOException
        {
            ...
            if( position > 0 )
            {
                if( encode )
                {
                    out.write( Base64Util.encode3to4( buffer, position ) );
                }   // end if: encoding
                else
                {   
